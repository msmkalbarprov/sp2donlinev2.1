...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <img src="<?= base_url('assets/img/BKAD_Logo SP2D Online putih.png'); ?>"alt="Logo" class="brand-image  elevation-3"
         >
    <span class="brand-text font-weight-light">SP2D ONLINE</span>
  </a>
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <?php if($this->session->userdata('username') == 'superadmin' || $this->session->userdata('username')=='kasubid3' ){ ?>
          <img src="<?= base_url('assets/dist/img/avatar-laki.png') ?>" class="img-circle elevation-2" alt="User Image">
          <?php }else{?>
            <img src="<?= base_url('assets/dist/img/avatar-hijab.png') ?>" class="img-circle elevation-2" alt="User Image">
