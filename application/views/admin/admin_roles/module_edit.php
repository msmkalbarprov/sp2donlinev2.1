                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="module_name" class="form-control" value="<?= $module['module_name']; ?>" id="module_name" placeholder="">
                                                    ...
                                                    <div class="col-lg-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea type="text" name="operation" class="form-control" id="operation" placeholder="eg. add|edit|delete"><?= $module['operation']; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
